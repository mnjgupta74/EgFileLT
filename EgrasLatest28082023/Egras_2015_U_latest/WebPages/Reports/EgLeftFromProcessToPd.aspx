<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage5.master" AutoEventWireup="true" CodeFile="EgLeftFromProcessToPd.aspx.cs" Inherits="WebPages_Reports_EgLeftFromProcessToPd" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script src="../../js/Control.js" type="text/javascript"></script>
    <fieldset style="width: 100%" id="FieldTreasury">
        <legend style="color: #336699;">Left From Process To PD List</legend>
        <table width="100%" style="text-align: center" align="center" border="1" cellpadding="0"
            ...
            <tr>
                <td colspan="3" style="text-align: center; height: 35px" valign="top">
                    <asp:Label ID="Labelheader" runat="server" Text=" Left From Process To Pd Report" Font-Bold="True"
            ...
            <tr>
                <td colspan="3">
                    <table border="0" cellpadding="0" cellspacing="0" style="font-size: 9pt; font-family: Arial; width: 100%">
                        <tr id="trLeftFromProcessTopd" runat="server" visible="false">
                            <td>
                                <asp:Repeater ID="RptleftFromProcessToPd" runat="server">
                                    <HeaderTemplate>
                                        <tr style="background-color: #507CD1; color: White; font-weight: bold; text-align: center; height: 20px">
                                            ...
                                            <td style="color: White; text-align: center;">Location
                                            </td>
                                            <td style="color: White; text-align: center;">BankChallanDate
                                            </td>
