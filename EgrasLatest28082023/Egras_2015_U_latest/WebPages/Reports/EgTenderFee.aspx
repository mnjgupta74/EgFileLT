<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage5.master" AutoEventWireup="true" CodeFile="EgTenderFee.aspx.cs" Inherits="WebPages.Reports.WebPages_EgTenderFee" Title="TenderFee" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div _ngcontent-c6="" class="tnHead minus2point5per">
        <h2 _ngcontent-c6="" title="Procurement Challan Reports" class="pull-left">
            <span _ngcontent-c6="" style="color: #FFF">Procurement Challan Reports </span></h2>
        <img src="../../Image/help1.png" class="pull-right" style="height: 44px; width: 34px;" title="ProcurementChallanReports" />
    </div>
    <table align="center" style="width: 100%" border="1">
        ...
        <tr runat="server" id="trrpt" visible="false">
            <td colspan="7">
                <center>
                    <rsweb:ReportViewer ID="rptProcurementChallanReports" runat="server" Width="100%" SizeToReportContent="true"
                        AsyncRendering="false" ShowRefreshButton="false" ShowExportControls="true" >
                    </rsweb:ReportViewer>
                </center>
            </td>
        </tr>
