...
public partial class WebPages_Reports_EgDMFTGrnList : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        dt=objTreasuryAndDept.FillDMFTRepeter();
        RptDMFTGrnList.DataSource = dt;
        RptDMFTGrnList.DataBind();
        if (dt.Rows.Count > 0)
        {
            trDmft.Visible = true;
        }
