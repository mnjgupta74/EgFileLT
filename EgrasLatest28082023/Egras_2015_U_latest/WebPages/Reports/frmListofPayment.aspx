        ...
        <tr>
            <td>
                <asp:RadioButtonList ID="RadioButtonList1" runat="server" CssClass="form-control" Style="margin-left: 25%; display: contents !important" Width="50%" RepeatDirection="Horizontal" ForeColor="#336699">
                    <asp:ListItem Value="1" Selected="True" style="margin-right: 40px;">Simple</asp:ListItem>
                    <asp:ListItem Value="2" style="margin-right: 40px;">PDF</asp:ListItem>
                </asp:RadioButtonList>

            </td>
            <td align="center">
                <asp:Button ID="btnSubmit" runat="server" Height="33" Style="margin-right: 20px" CssClass="btn btn-default" Text="Show" OnClick="btnSubmit_Click"
                    ValidationGroup="a" TabIndex="3" />
                <div class="col-md-3">
                    <asp:Button ID="btnSignPdf" Height="33" style="margin-right: -70%;" CssClass="btn btn-default pull-right" runat="server" Text="SignPDF" ValidationGroup="a" OnClick="btnSignPdf_Click" />
                </div>
                <asp:Button ID="btnReset" runat="server" Text="Reset" Height="33" CssClass="btn btn-default" ValidationGroup="a" OnClick="btnReset_Click" />
            </td>
        </tr>
