    ...
    <table width="100%" style="text-align: center" align="center" border="1">
        ...
        <tr>
            ...
            <td>
                <div class="row">
                    <div class="col-md-4">
                        <asp:Button ID="btnSubmit" Height="33" runat="server" CssClass="btn btn-default pull-right" Text="Show" 
                            OnClick="btnSubmit_Click" ValidationGroup="a" TabIndex="3" />
                    </div>
                    <div class="col-md-2">
                        <asp:Button ID="btnPrint" Height="33" CssClass="btn btn-default pull-right" runat="server" Text="PDF" 
                            ValidationGroup="a" OnClick="btnPrint_Click" />

                    </div>
                    <div class="col-md-2">
                        <asp:Button ID="btnSignPdf" Height="33" CssClass="btn btn-default pull-right" runat="server" Text="SignPDF" 
                            ValidationGroup="a" OnClick="btnSignPdf_Click" />
                    </div>
                    <div class="col-md-2">
                        <asp:Button ID="btnReset" Height="33" runat="server" CssClass="btn btn-default pull-right" Text="Reset" 
                            ValidationGroup="de" OnClick="btnReset_Click" />
                    </div>
                </div>
