        ...
        <ContentTemplate>--%>
            ...
            <table width="100%" style="text-align: center" align="center" border="1">
                ...
                <tr>
                    ...
                    <td>
                        <div class="col-md-5">
                            <asp:Button ID="btnshow"  CssClass="btn btn-default pull-right" runat="server" Text="Show" Height="100%" ValidationGroup="de" OnClick="btnshow_Click" />
                        </div>
                        <div class="col-md-3">
                    ...
                    <td align="right" id="tdrow" visible="false" runat="server">
                        <asp:Label runat="server" ID="lblTotalRow" style="font-weight: 600;"></asp:Label>
                        <hr/>
                        <asp:Label runat="server" ID="lblTotalAmount"  style="font-weight: 600;"></asp:Label>
