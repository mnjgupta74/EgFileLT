<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage5.master" AutoEventWireup="true"
    CodeFile="EgReleasedGRN.aspx.cs" Inherits="WebPages_Reports_EgReleasedGRN" Title="Untitled Page" %>
        ...
        <ContentTemplate>
            ...
            <div _ngcontent-c6="" class="tnHead minus2point5per">
                <h2 _ngcontent-c6="" title="Released GRN" class="pull-left">
                    <span _ngcontent-c6="" style="color: #FFF">Released GRN </span></h2>
            ...
            <table style="width: 100%" align="center" id="Ttable">
                <div id="rptSchemaDi" runat="server" visible="false">
                    ...
                    <asp:Repeater ID="rptrReleasedGRN" runat="server">
                        <HeaderTemplate>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="left"><%# DataBinder.Eval(Container.DataItem,"LoginId")%></td>
                        ...
                        <FooterTemplate>
                           <tr>
                                 <asp:Label ID="Label1" runat="server"  Text="No Data Found!"  Visible='<%# bool.Parse((rptrReleasedGRN.Items.Count == 0).ToString()) %>'></asp:Label>
                           </tr>
                        </FooterTemplate>
                    </asp:Repeater>
