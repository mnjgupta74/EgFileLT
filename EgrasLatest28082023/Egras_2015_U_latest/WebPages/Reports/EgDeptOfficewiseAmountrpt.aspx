...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="">
        ...
        <div  style="border: 1px solid; width: 100%; margin-left: 0px; padding: 5px;">
            <div class="row">
                <div class="col-md-3">
                    <label style="color:#336699">BudgetHead:</label>
            ...
            <div class="row text-center" style="margin-top: 10px; margin-bottom: 15px;">
                <button id="btnSubmit" type="submit" class="btn btn-primary" style="width:15%;">Submit</button>
            </div>
        </div>
