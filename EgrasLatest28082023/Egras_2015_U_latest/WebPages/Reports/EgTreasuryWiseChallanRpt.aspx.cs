...
public partial class WebPages_Reports_EgTreasuryWiseChallanRpt : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if ((Session["UserType"].ToString().Trim() == "3".Trim()))
            {
                ...
                ddllocation.SelectedValue = objEgBankSoftCopyBl.GetBSRCode().Trim();
    ...
    public void Loadreport()
    {
        ...
        objTy11.tcode = ddllocation.SelectedValue.Trim();
    ...
    public void LoadReport()
    {
        ...
        rptreasury = ddllocation.SelectedValue.Trim();
