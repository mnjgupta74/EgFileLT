...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tr align="center">
                    ...
                    <td colspan="4" align="center">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <asp:Button ID="btnMsExcel" Height="33" width="80%" CssClass="btn btn-default pull-right" runat="server" Text="DownloadExcel" ValidationGroup="de" OnClick="btnMsExcel_Click" />
                            </div>
                            <div class="col-md-4">
                    ...
                    <td align="center" colspan="4">
                        <asp:GridView ID="grdScroll" runat="server" AutoGenerateColumns="False" Font-Names="Verdana"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="BankResponseDate">
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="200px" />
                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblBankDate" styl="margin-left:10px;" runat="server" Text='<%# Eval("BankResponseDate","{0:MM/dd/yyyy HH:mm:ss}") %>' />
                                    </ItemTemplate>
                                ...
                                <asp:BoundField DataField="ETreasuryAmount" HeaderText="E-Treasury Amount" DataFormatString="{0:n}">
                                    <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                    <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                </asp:BoundField>
                                <asp:BoundField DataField="ScrollAmount" HeaderText="Scroll Amount" DataFormatString="{0:n}">
                                    <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                    <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                </asp:BoundField>
          ...
          <Triggers>
        <asp:PostBackTrigger ControlID="btnMsExcel" />
    </Triggers>
