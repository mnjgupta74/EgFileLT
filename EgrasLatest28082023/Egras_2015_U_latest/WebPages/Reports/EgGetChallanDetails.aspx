    ...
    <table id="tblheader" border="1" align="center" width="100%" cellpadding="1" cellspacing="1">
        <tr>
            ...
            <td style="text-align: left" colspan="3">
                <asp:TextBox ID="txtGRN" runat="server" width="200px" onkeyup="NumberOnly(this);" CssClass="form-control"
                    MaxLength="12"></asp:TextBox>
            </td>
        </tr>
        <tr id="trDate" runat="server">
            <td align="left"><b><span style="color: #336699">From Date :</span></b> &nbsp;&nbsp;&nbsp;
            </td>
            <td align="left">
            ...
            <td align="left">&nbsp;<b><span style="color: #336699">To Date :</span></b> &nbsp;&nbsp;
            </td>
            <td align="left">
                <asp:TextBox ID="txttodate" runat="server" CssClass="form-control"  width="200px"
        ...
        <tr>
            <td colspan="4" align="center">
                <asp:Button ID="btnSubmit" Height="35px" CssClass="btn btn-default" runat="server" ValidationGroup="a" Text="Search" OnClick="btnSubmit_Click" />
            </td>
        </tr>
