...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        function checkDate(sender, args) {
         ...
         $(document).ready(function () {
            $('[name*="ctl00$ContentPlaceHolder1$btnSearch"]').click(function () {
                if ($(<%=txtgrn.ClientID%>).val() != "" && <%=txtgrn.ClientID%>).val().length<=12) {
                    $('#cover-spin').show(0)
                }
            });
        });
   ...
   <div _ngcontent-c6="" class="tnHead minus2point5per">
        <h2 _ngcontent-c6="" title="Edit Refund Amount Bill Number" class="pull-left">
            <span _ngcontent-c6="" style="color: #FFF">Edit Refund Amount Bill Number</span></h2>
        <img src="../../Image/help1.png" class="pull-right" style="height: 44px; width: 34px;" title="Edit Refund Amount Bill Number" />
    </div>
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-12" style="text-align: center; padding-bottom: 40px">
                       <b> <span style="color: #336699; margin-top: 10px; font-size: 15px">GRN:</span></b>
                                <asp:TextBox ID="txtgrn" runat="server" Height="40px" type="number" MaxLength="12" onkeypress="Javascript:return NumberOnly(event)"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="btnSearch" CssClass="btn btn-default" CommandName="search" runat="server" Text="Submit" OnClientClick="PwdEnable(); return false;"
                        OnClick="btnSearch_Click" Height="40px" Width="10%" Style="font-size: 15px;" />&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="btnReset" CssClass="btn btn-default" CommandName="search" runat="server" Text="Reset" Style="font-size: 15px;" Height="40px" Width="10%"
