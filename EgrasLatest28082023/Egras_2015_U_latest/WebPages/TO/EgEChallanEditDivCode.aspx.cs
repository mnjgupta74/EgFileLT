...
public partial class WebPages_EgEChallanEditDivCode_temp : System.Web.UI.Page
{
    ...
    protected void rptrManualSuccess_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "Edit")
        {
            ...
            Label lblMerchantGrn = (Label)e.Item.FindControl("lblMerchantGrn");
            ...
            if (lblEdit.Text == "Edit")
            {
                ...
                {
                    ScriptManager.RegisterClientScriptBlock(Page, this.GetType(), "MSG", "myAlert( 'As Per Government order Division Code would not be edit those GRN is made by Merchant');", true);
                    //ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "clentscript", "alert('Can not Edit Grn')", true);
                    lblEdit.Text = "Edit";
