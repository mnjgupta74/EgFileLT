    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div _ngcontent-c6="" class="sectiontopheader tnHead minus2point5per">
               ...
               <table width="100%" border="1" align="center" style="border: 1px solid;">
                <tr>
                    <td align="center">
                ...
                <tr>
                    <td id="RowFromDate" runat="server" align="center" visible="false">
                        ...
                        <div style="display: inline-table">
                            <asp:TextBox ID="txtFromDate" runat="server" CssClass="form-control" Height="30px" Style="margin-top: 5px"
                                onChange="javascript:return dateValidation(this,ctl00_ContentPlaceHolder1_txtToDate)" Width="150px"></asp:TextBox>
                    ...
                    <td id="RowToDate" runat="server" align="center" visible="false" colspan="2">
                        ...
                        <div style="display: inline-table">
                            <asp:TextBox ID="txtToDate" runat="server" CssClass="form-control" Height="30px" Style="margin-top: 5px"
                                onChange="javascript:return dateValidation1(this,ctl00_ContentPlaceHolder1_txtFromDate)" Width="150px"></asp:TextBox>
                    ...
                    <td id="RowSearch" runat="server" align="center" visible="false" colspan="3">
                        ...
                        <div style="display: inline-table">
                            <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" Height="30px" Style="margin-top: 5px"
