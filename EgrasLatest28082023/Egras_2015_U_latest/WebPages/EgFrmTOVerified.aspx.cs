...
public partial class WebPages_EgFrmTOVerified : System.Web.UI.Page
{
    ...
    //protected void grdVerifyChallan_RowDataBound(object sender, GridViewRowEventArgs e)
    //{
    //    //Checking the RowType of the Row  
    //    if (e.Row.RowType == DataControlRowType.DataRow)
    //    {
            
    //        //LinkButton lnkRepeat = (LinkButton)e.Item.FindControl("LinkButtonStatus");
    //        //If Salary is less than 10000 than set the row Background Color to Cyan  
    //        if (Convert.ToInt32(e.Row.Cells[2].Text) == 1000199)
    //        {
