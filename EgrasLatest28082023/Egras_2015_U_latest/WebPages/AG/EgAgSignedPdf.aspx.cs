...
public partial class WebPages_Reports_EgAgSignedPdf : System.Web.UI.Page
{
    ...
    protected void btnshow_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if ((date1.Day == 1 && date2.Day == 10) || (date1.Day == 1 && date2.Day == LastDay) || rblFileType.SelectedValue == "2")
            {
    ...
    private void SavePDF()
    {
        ...
        if (rblFileType.SelectedValue == "1")
        {
            ...
            result = objAGSReport_BL.SavePDF();
        }
        else
        {
            DateTime date1 = DateTime.ParseExact(txtfromdate.Text, "dd/MM/yyyy", null).Date;
            objAGSReport_BL.Filedate = date1;
            result = objAGSReport_BL.SaveDailyPDF();
        }
