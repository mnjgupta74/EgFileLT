        ...
        <ContentTemplate>
            <div _ngcontent-c6="" class="sectiontopheader tnHead minus2point5per">
               ...
               <%--<img src="../../Image/help1.png" style="height: 35px;width: 34px;" data-toggle="tooltip" data-placement="left" Title="" />--%>
                ...
                <table width="100%" >
                     <tr> <td style="color: #336699;">  <label Id="lblTotalTreasuryWise" visible="false"  runat="Server" text="" > Total Amount TreasuryWise In (CR.)  : </label>
                          
                          

                          <label  Id="lblTotalTreasuryWiseAmount"  runat="Server"  > </label></td>
                     </tr>
                      <tr></tr>
