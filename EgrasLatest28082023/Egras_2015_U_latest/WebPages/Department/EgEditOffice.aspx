...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    url: '<%= ResolveUrl("~/WebPages/Department/EgEditOffice.aspx/GetGRNDetail") %>',
                            ...
                            success: function (msg) {
                                ...
                                if (msg.d.length > 0) {
                                    ...
                                    var row = $("#tbDetails").append('<tr class="padding"><td colspan="2"><b><span style="color: #336699">District :</span></b><select id="ddlDistrict" onchange="GetSelectedTextValue(this)" style="margin-left: 38px"></select></td></tr><tr class="padding"><td colspan="2"><b><span style="color: #336699">Office Name : </span></b> <select id ="ddlOffice"></select></td></tr><br>');
                                    ...
                                    $("#tbDetails").append('<tr class="padding"><td style="text-align: center;"><input style="height:35px;width:20%" id="updtbtn" class="btn btn-primary" type="button" value="Update" onClick="UpdateData(); return false;"/></td></tr>');
                                }
                                else {
    ...
    <div _ngcontent-c6="" class="tnHead minus2point5per">
        <h2 _ngcontent-c6="" title="Transfer Office">
            <span _ngcontent-c6="" style="color: #FFF">Transfer Office</span></h2>
        <img src="../../Image/help1.png" style="height: 35px; width: 34px;" data-toggle="tooltip" data-placement="right" title="Transfer Office" />
    </div>
    ...
    <div class="row"  style="border: 1px solid; width: 100%; margin-left: 0px; padding: 5px;">
        <div class="col-md-12" style="text-align: center">
            <div id="sh1">
                ...
                <input id="idGRN"  type="number" maxlength="12" style="width: 20%; height: 35px; font-size: 18px;" min="1" onkeypress="Javascript:return NumberOnly(event)" />
                <input id="inpsubmit" class="btn btn-primary" style="margin-left: 26px; height: 35px; width: 10%" type="submit" onclick="ShowData(); return false" value="Submit" />
                <input id="reset" type="submit" class="btn btn-primary" value="Reset" style="margin-left: 26px; height: 35px; width: 10%" />
            </div>
