...
namespace EgBL
{
    ...
    public class EgDeptIntegrationPropBL
    {
        ...
        public string city(string City)
        {
            ...
            {
                { throw new Exception("City Cannot be null and length must be less than 20 and special character not allowed"); }
            }
            return City;
        }
        ...
        public double deductCommission(string DeductCommission)
        {
            ...
            if (!isNumeric)
                throw new Exception("deduct commission is invalid");
            if (discount < 0)
            {
