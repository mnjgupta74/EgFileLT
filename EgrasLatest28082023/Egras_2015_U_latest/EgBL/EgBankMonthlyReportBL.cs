...
namespace EgBL
{
    public class EgBankMonthlyReportBL
    {
        ...
        public void InsertDMSdata(DataTable dt)
        {
            ...
            PM[0] = new SqlParameter("@mytable", SqlDbType.Structured);
            PM[0].Value = dt;
            PM[1] = new SqlParameter("@IpAddress", SqlDbType.NVarChar, 50);
            PM[1].Value = System.Web.HttpContext.Current.Request.ServerVariables[ConfigurationManager.AppSettings["IPAddressHTTP"]].ToString();  //Convert.ToString(System.Web.HttpContext.Current.Request.ServerVariables["REMOTE_ADDR"]);
