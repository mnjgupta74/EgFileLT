...
namespace EgBL
{
    public class EgEChallanBL : EgUserRegistrationBL
    {
        ...
        {
            SqlParameter[] PM = new SqlParameter[0];
            gf.FillListControl(ddl, "EgGetUpiBankList", "BankName", "BSRCode", PM);
            ddl.Items.Insert(0, new ListItem("--Select Bank--", "0"));
        }
        /// <summary>
        ...
        /// fill RBI bank
        /// </summary>
        public void FillRBIBanks(DropDownList ddl)
        {
            SqlParameter[] PARM = new SqlParameter[0];
             gf.FillListControl(ddl, "EgGetRBIBanksList", "BankName", "BSRCode", PARM);
