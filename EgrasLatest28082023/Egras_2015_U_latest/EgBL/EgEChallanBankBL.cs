...
namespace EgBL
{
    public class EgEChallanBankBL
    {
        ...
        /// <summary>
        /// Get Amount for fail Transaction  And Set At Update Time
        /// 22 june 2023
        /// </summary>
        /// <returns></returns>
        public string GetEpayAmount()
        {
            ...
            PARM[0] = new SqlParameter("@GRN", SqlDbType.BigInt) { Value = GRN };
            PARM[1] = new SqlParameter("@epayBankCode", SqlDbType.VarChar, 10) { Value = epayBSRCode };
            string Amount = gf.ExecuteScaler(PARM, "EgGetEpayAmount");
            return Amount;
        }

        public int CheckGRNValidation()
        {
            gf = new GenralFunction();
            SqlParameter[] PARM = new SqlParameter[4];
            ...
            PARM[1] = new SqlParameter("@GRN", SqlDbType.BigInt) { Value = GRN };
            PARM[2] = new SqlParameter("@amount", SqlDbType.Money) { Value = Amount };
            PARM[3] = new SqlParameter("@bankCode", SqlDbType.Char, 7) { Value = BankCode };
            return Convert.ToInt32(gf.ExecuteScaler(PARM, "EgCheckUserBankStatusOnline"));
        }
