...
PARM[4] = new SqlParameter("@IpAddress", SqlDbType.VarChar, 20) { Value = IpAddress };
            return gf.UpdateData(PARM, "EgInsertReleaseMerchantAudit");
        }
        /// <summary>
        ///  Office IntiatorID,Initiator,GRN,Amount,AcceptedDate,AcceptedStatus,PDFFile
        /// </summary>
        /// <returns></returns>
        public DataTable InsertDefaceReleaseRequest()
        {
            SqlParameter[] PARM = new SqlParameter[4];
            gf = new GenralFunction();
            DataTable dt = new DataTable();
            PARM[0] = new SqlParameter("@InitiatorID", SqlDbType.BigInt) { Value = System.Web.HttpContext.Current.Session["UserId"] };
            PARM[1] = new SqlParameter("@GRN", SqlDbType.BigInt) { Value = Grn };
            PARM[2] = new SqlParameter("@Amount", SqlDbType.Money) { Value = Amount };
            PARM[3] = new SqlParameter("@PDFFile", SqlDbType.VarBinary) { Value = PdfByte };
            //--PARM[4] = new SqlParameter("@ReferenceID", SqlDbType.BigInt) { Value = ReferenceNo };
            //--PARM[4].Direction = ParameterDirection.Output;
            return gf.Filldatatablevalue(PARM, "EgCheckDefaceReleaseAmountForOffice", dt, null);
           
        }

        public DataTable EgGetDefacerequestStatus()
        {
            SqlParameter[] PARM = new SqlParameter[3];
            gf = new GenralFunction();
            DataTable dt = new DataTable();
            PARM[0] = new SqlParameter("@ID", SqlDbType.BigInt) { Value = System.Web.HttpContext.Current.Session["UserId"] };
            PARM[1] = new SqlParameter("@GRN", SqlDbType.BigInt) { Value = Grn };
            PARM[2] = new SqlParameter("@Usertype", SqlDbType.Int) { Value = System.Web.HttpContext.Current.Session["UserType"] };
           
            //--PARM[4] = new SqlParameter("@ReferenceID", SqlDbType.BigInt) { Value = ReferenceNo };
            //--PARM[4].Direction = ParameterDirection.Output;
            return gf.Filldatatablevalue(PARM, "EgGetDefacerequestStatus", dt, null);
