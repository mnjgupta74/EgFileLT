...
namespace EgBL
{
    public class EgLoginBL
    {
                    ...
                    else
                    {
                        switch (UserType)
                        {
                            ...
                            case 4:
                                ...
                                else if (Userflag.ToUpper() == "U")             // Update Login Id With Off
                                {
                            ...
                            case 2:
                                ...
                                {
                                    AddressUrl = "~/WebPages/TO/EgToHome.aspx";
                                    SessionActive(1);
                                }
                                break;
                            case 1:
                            ...
                            case 11:
                                ...
                                {
                                    AddressUrl = "~/WebPages/To/EgReleaseDefacedEntry.aspx";
                                    SessionActive(1);
                                }
                                break;
                            ...
                            case 12:
                                ...
                                {
                                    AddressUrl = "~/WebPages/AG/EgRevenueHeadRpt.aspx";
                                    SessionActive(1);
                                }
                                break;
                        }
        ...
        /// <summary>
        /// Add New Method for Display Circular from DataBase 6 May 2022
        /// </summary>
        /// <param name="rpt"></param>
        public void CircularPdfNew(GridView rpt)
        {
            gf = new GenralFunction();
            PagedDataSource objpds = new PagedDataSource();
            DataTable dt = new DataTable();
