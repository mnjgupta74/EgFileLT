...
<body>
    <form id="form1" runat="server">
        ...
        <div style="width: 59%; margin: auto;">
            <%--<fieldset>
               <legend>--%>
            <div class='shadow' id='div3' style="border: 2px solid #999999; background-color: white; color: Black; padding-bottom: 5px; overflow: auto; top: 0px; z-index: 40;  text-align: left; margin-top: 15px;">
                <%--<div id="divHeader">--%>
                ...
                <div id="DivContent" style="padding-left:20px;">
                    <asp:DataList ID="dlCustomers" runat="server" onKeyPress="return DisableControlKey(event)" onKeyDown="if(event.ctrlKey && event.keyCode==86){return false;}" onMouseDown="return DisableControlKey(event)" RepeatLayout="Table" RepeatColumns="2"
                        Width="100%" align="center" CellPadding="2" CellSpacing="0" Border="0" >
                    </asp:DataList>
                </div>
                <%--</fieldset>--%>
            </div>
