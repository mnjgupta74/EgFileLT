...
public class MEIntegration : DeptIntegrationChallans
{
    ...
    public override void SplitToProperties(string PlainText)
    {
        ...
        Data.Add("DeductCommission", new IntegrationProp() { Value = 0.00, ParameterName = "@DeductCommission", DbType = SqlDbType.Money });
        ...
        Data.Add("TotalAmount", new IntegrationProp() { Value = objEgDeptIntegrationPropBL.amount(ChallanValues[7][1].ToString()), ParameterName = "@TotalAmount", DbType = SqlDbType.Money });
