...
// NOTE: You can use the "Rename" command on the "Refactor" menu to change the class name "EgSnaPayUForward" in code, svc and config file together.
public class EgSNADataPull : IEgSNADataPull
{
    public string PullData(string RequestParm)
    {
        try
        {
            EgSnaPayUForwarBL objEgSnaService = new EgSnaPayUForwarBL();
