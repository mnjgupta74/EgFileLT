...
public class Service : System.Web.Services.WebService
{
            ...
            if (result.ToString() == "1")
            {
                ...
                switch (BsrCode)
                {
                    ...
                    case "0171051":
                        ...
                        break;
                    case "0006326":
                        PlainText = objEncry.DecryptAES256(encData, System.Web.Configuration.WebConfigurationManager.AppSettings["Securekey"]+"RAJASTHAN_EGRASS.key",null);
                        result = UpdateStatus(PlainText, encData, BsrCode);
                        break;
                    case "0304017":
    ...
    {
        // Jsonencdata = "{\"GRN\":\"74441373\",\"Bank_Code\": \"9920001\",\"BankReferenceNo\": \"CK58102178\",\"CIN\": \" 992000106494921012019\",\"Paid_Date\": \"2019/11/27 13:27:00\",\"Paid_Amt\":\"100.00\",\"TRANS_STATUS\":\"S\",\"GT_BSRCode\":\"eChallan\",\"BankRefNo\": \"XXXXX\",\"PayMode\": \"CC\",\"SecurityToken\": \"DCDCF7FA0B8C0D2FC08B569E839B1FA67834B4B59D592F988AC501CC93B66ADA\"}";
        string rv = string.Empty;
        var myDetails = JsonConvert.DeserializeObject<PineLabs>(Jsonencdata);
        InsertAuditTransaction(Jsonencdata, BsrCode, myDetails.GRN);
...
class PineLabs
{
    ...
    public string CIN
    {
        ...
        set
        {
            ...
            {
                throw new Exception("CIN is Null OR CIN Is Less Than 20 ");
            }
            cin = value;
        }
    }
