...
public class EgReleaseAmount : System.Web.Services.WebService
{
    ...
    public string ReleaseAmount(string ParameterStr)//ReleaseAmount
    {
        ...
        if (flag)
        {
            try
            {
                objEgReleaseGrn.EncData = ConfigurationManager.AppSettings["ServerName"].ToString() + " => " + Parameter;
                objEgReleaseGrn.Grn = Grn;
                objEgReleaseGrn.Amount = Amount;
                objEgReleaseGrn.MapCode = key;// Merchant Code
                objEgReleaseGrn.Flag = flag;
                objEgReleaseGrn.IpAddress = System.Web.HttpContext.Current.Request.ServerVariables[ConfigurationManager.AppSettings["IPAddressHTTP"]].ToString();
    ...
    private string VerifyGrn()
    {
        try
        {
            ...
            SbiEncryptionDecryption objDecrypt = new SbiEncryptionDecryption();
            objEgReleaseServiceBL.EncData = ConfigurationManager.AppSettings["ServerName"].ToString() + " => " + "Verify_" + Parameter;
            ...
            objEgReleaseServiceBL.IpAddress = System.Web.HttpContext.Current.Request.ServerVariables[ConfigurationManager.AppSettings["IPAddressHTTP"]].ToString();//IPAddress
    ...
    private string Validation(int val , string SCode)
    {
        ...
        objEgReleaseGrn.EncData = ConfigurationManager.AppSettings["ServerName"].ToString() + " => " + Parameter + "_" + Status + "_" + Message;
