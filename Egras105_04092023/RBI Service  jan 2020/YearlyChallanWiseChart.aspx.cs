...
public partial class YearlyChallanWiseChart : System.Web.UI.Page
{
    StringBuilder sb;
    ...
    public void ChartFun()
    {
        ...
        dt2 = new DataTable();
        objYearWise.FillRepeterYearly(dt2);
        if (dt2.Rows.Count > 0)
        {
            fldColumn.Visible = true;
            //fldPie.Visible = true;
    ...
    public void Column3dChartBENextExp1(DataTable dt)
    {
        ...
        sb.Append("chart.zoomToIndexes(chartData.length - 15, chartData.length - 1);");
        sb.Append("}");
        //End Zoom
        ...
        for (int i = 0; i <= dt.Rows.Count - 1; i++)
        {
            ...
            sb.Append("var Year = '" + dt.Rows[i]["Year"].ToString() + "';");
            ...
            sb.Append("var trans = " + Convert.ToInt64(dt.Rows[i]["NoTransaction"].ToString()) + ";");
            sb.Append(" var color =  '#FFA500';");
            sb.Append(" var color1 =  '#808000';");
            //sb.Append(" var color =  colors[" + 9 + "];");
            //            sb.Append(" var color1 =  colors[" + 4 + "];");
            sb.Append(" var Amount = '" + Convert.ToInt64(dt.Rows[i]["Amount"].ToString())*10000000 + "';");
        ...
        sb.Append("chart.categoryField = 'Year';");
        ...
        sb.Append("graph2.balloonText = ' [[category]]  : (Transaction :[[value]])';");
        //"Income: [[value]]"
    ...
    //    {
    //        TotalTrans += (Int32)((DataRowView)e.Item.DataItem)["NoTransaction"];
