...
public partial class SampleMerchantpreLogin2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            int version = objEgCheckBudgetHead.GetMerchantinfo();
            ...
            //if (objEgCheckBudgetHead.GetMerchantinfo() != 1)
            {
                ...
                //ViewState["AUIN"] = AUIN;
                hdnVersion.Value = version.ToString();
                field1.Visible = true;
                SetSessionValues();
            }
              ...
              {
                 IntegrationClass.errorName= "AUIN  Already Exist" + "*" + Mcode + "*" + AUIN;
    ...
    public static string GetBanks(string EncData, string AUIN, string Mcode, string ChallanType, string Version)
    {
        try
        {
            DeptIntegrationController objDeptIntegrationController = new DeptIntegrationController();
            bool result = objDeptIntegrationController.CheckData(new IntegrationClass(EncData.Trim(), AUIN.Trim(), Convert.ToInt32(Mcode), ChallanType.Trim(), Convert.ToInt16(Version)));
