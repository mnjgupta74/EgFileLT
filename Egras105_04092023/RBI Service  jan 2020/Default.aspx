...
<body>
    <form id="form1" runat="server" novalidate>
                    ...
                    <div class='brd1 shadow login' id='div3' style="color: Black; padding-bottom: 5px; min-height: 375px; overflow: auto; top: 0px; z-index: 40;">
                        ...
                        <p style="padding-left: 5px; margin-right: 0px; text-align: left; /*background-image: url('Image/imagesCAKCNEEP.jpg'); */ text-decoration: blink; background-repeat: no-repeat;">
                            ...
                            <div class="col-md-12">
                                ...
                                <%--73c773--%>
                                <div class="panel col-md-12" style="text-align: left; border-radius: 0px; margin-bottom: 0px; background-color: white; padding: 5px;">
                                    <ul>
                                        <div class="col-md-4" style="padding-left: 0px; padding-right: 0px;">
                                            <li>
                                                <%--<img src="Image/EpayBanksLogo/SBI.png" />&nbsp;--%>
                                                <a style="padding: 5px; background-color: #73c773;" href="GetGRNStatus.aspx"><b>GRN Status</b></a>
                                            </li>
                                        </div>
                                        <div class="col-md-4" style="padding-left: 0px; padding-right: 0px;">
                                            <li>
                                                <%--<img src="Image/EpayBanksLogo/PNB.png" />&nbsp;--%>
                                                <a style="padding: 5px; background-color: #73c773;" href="AboutGras.aspx"><b>About Egras</b></a>
                                            </li>
                                        </div>
                                        <div class="col-md-4" style="padding-left: 0px; padding-right: 0px;">
                                            <li>
                                                <%--<img src="Image/EpayBanksLogo/CBI.png" />&nbsp;--%>
                                                <a style="padding: 5px; background-color: #73c773;" href="RefundProcess.aspx"><b>Refund Process</b></a>
                                            </li>
                                        </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div id="EPayBanks" class="row" style="color: #2874f0">
                                    ...
                                    <div class="col-md-4 col-sm-6" style="padding-right: 0px;">
                                        <li>HDFC Bank                                   </li>
                                        <li>ICICI Netbanking                            </li>
                                        <li>IDBI Bank IDFC Netbanking                   </li>
        ...
        <div>
            <img runat="server" id="img1" src="" />
        </div>
        <div id="divDMSPDF" runat="server" visible="True" style="text-align: center">
            <iframe id="iFrameDMSPDF" width="720px" height="380px" name="ContainerIframe" runat="server"></iframe>
        </div>
    </form>
</body>
</html>
