...
namespace EgBL
{
    public  class EgEMinusChallanBL:EgEChallanBL
   {
       ...
       public override  int InsertChallan()
       {
           ...
           PARM[27] = new SqlParameter("@IpAddress", SqlDbType.VarChar, 20) { Value = HttpContext.Current.Request.ServerVariables["REMOTE_ADDR"].ToString() }; // add Ip Nov12 2019
            int Rv = gf.UpdateData(PARM, "egechallan_integration");
