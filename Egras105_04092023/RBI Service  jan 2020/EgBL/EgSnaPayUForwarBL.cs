    ...
    public class EgSnaPayUForwarBL
    {
        ...
        private string GetStatusCode()
        {
            try
            {
                ...
                SnaDate = objDecrypt.DecryptSBIWithKey256(enctype, System.Web.Configuration.WebConfigurationManager.AppSettings["Securekey"] + ObjSNAMerchantCode.GetKey(key)+ ".key",null);
                try
                {
        ...
        private string Validation(string SCode)
        {
            ...
            retMsg = SCode == "200" ?
                 ...
                 System.Web.Configuration.WebConfigurationManager.AppSettings["Securekey"] + ObjSNAMerchantCode.GetKey(key) + ".key",null) :
