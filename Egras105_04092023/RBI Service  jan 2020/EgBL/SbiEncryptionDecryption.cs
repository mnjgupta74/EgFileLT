...
namespace EgBL
{
    public class SbiEncryptionDecryption
    {
        ...
        {
            //Decrypt256(textToDecrypt, FilePath);
               RijndaelManaged rijndaelCipher = new RijndaelManaged();
            rijndaelCipher.Mode = CipherMode.CBC;
            rijndaelCipher.Padding = PaddingMode.PKCS7;
            rijndaelCipher.KeySize = 0x80;
        ...
        // Aes 256 Bit Encrtpy Decrpt 1 Oct 2020
        public string Encrypt256(string textToEncrypt, string FilePath)
        {
            RijndaelManaged rijndaelCipher = new RijndaelManaged();
            rijndaelCipher.Mode = CipherMode.CBC;
            rijndaelCipher.Padding = PaddingMode.PKCS7;
        ...
        public string Decrypt256(string textToDecrypt, string FilePath)
        {
            RijndaelManaged rijndaelCipher = new RijndaelManaged();
            rijndaelCipher.Mode = CipherMode.CBC;
            rijndaelCipher.Padding = PaddingMode.PKCS7;
        ...
        public string EncryptWithKey(String messageToEncrypt, string Path,byte[] nonSecretPayload = null)
        {
        ...
        public  string DecryptWithKey(string encryptedMessage, String keypath, String excepStr, int nonSecretPayloadLength = 0)
        ...
        public string EncryptSBIWithKey256(String messageToEncrypt, string Path, byte[] nonSecretPayload = null)
        {
            byte[] key = File.ReadAllBytes(Path);
        ...
        public string DecryptSBIWithKey256(string encryptedMessage, String keypath, String excepStr, int nonSecretPayloadLength = 0)

        {
            ...
            return System.Text.Encoding.UTF8.GetString(plaintext).TrimEnd("\r\n\0".ToCharArray());
        }
        private byte[] DecryptWithKey(byte[] encryptedMessage, String keypath, String excepStr, int nonSecretPayloadLength = 0)
        {
            byte[] key = File.ReadAllBytes(keypath);
        ...
        public string DecryptePay(string encryptedText, string completeEncodedKey)
        {
