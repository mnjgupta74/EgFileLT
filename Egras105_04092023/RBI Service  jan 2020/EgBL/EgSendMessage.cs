...
namespace EgBL
{
    ...
    public class EgSendMessage
    {
        ...
        public bool send(string uid, string password, string message, string no, string SENDERID)
        {
            ...
            (System.Net.HttpWebRequest)WebRequest.Create("http://smsgw.sms.gov.in/failsafe/HttpLink?username=" + uid + "&pin=" + password + "&message=" + message + "&mnumber=" + no + "&signature=" + SENDERID + "&dlt_entity_id=" + dlt_entity + "&dlt_template_id=" + dlt_tempate_id);
