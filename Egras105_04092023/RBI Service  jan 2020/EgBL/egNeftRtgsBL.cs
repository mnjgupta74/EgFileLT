    ...
    public class egNeftRtgsBL : ResponsePayload
    {
        ...
        public string InsertRBIResponse()
        {
            ...
            try
            {
                ...
                return gf.UpdateData(PARM, "EgInsertRBIResponseLog").ToString().Trim();
            }
            catch (Exception ex)
            {
                str = "CPNT0003";
        ...
        public string InsertNEFTResponse()
        {
            ...
            try
            {
                ...
                return gf.UpdateData(PARM, "EgInsertNFTResponse").ToString().Trim();
            }
            catch (Exception ex)
            {
                str = "CPNT0003";
        ...
        public string CPINNotificationReq()
        {
            ...
            try
            {
                ...
                str = gf.UpdateData(PARM, "CPINNotificationReq").ToString();
            }
            catch (Exception ex)
            {
                str = "CPNT0003";
        ...
        public string CheckReturnNotifyReq()
        {
            ...
            try
            {
                ...
                str = gf.UpdateData(PARM, "CPINReturnNotificationReq").ToString();
            }
            catch (Exception ex)
            {
                str = "CPNT0003";
        ...
        public string CPINPUSHREQ(Int64 GRN)
        {
            ...
            if (Rowcont > 0)
            {
                ...
                X509Certificate2 cert = new X509Certificate2((certificatePath), ConfigurationManager.AppSettings["CertificatePassword"].ToString(), X509KeyStorageFlags.Exportable);
        ...
        public string CPINPUSHRES(string json)
        {
            ...
            EgErrorHandller obj = new EgErrorHandller();
            obj.InsertError("neftRTGS Plain String  : " + result);
            ...
            obj.InsertError("neftRTGS Insert Nert Response  : " + result);
            return res.ToString();
        }
