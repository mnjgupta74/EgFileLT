    ...
    public class EgSSPIntegrastion
    {
        ...
        public bool CheckIntegrationData(string PlainText)
        {
            ...
            //{
                ...
                CheckBudgetHeadConditions(MerchantCode == "5025" ? "ME" : "");
                CheckAmount();
                checkFiller();
        ...
        public void SplitToPropertiesGeneral(string PlainText)
        {
            ...
            //ddo = objEgDeptIntegrationPropBL.officeCode(ChallanValues[24][1].ToString(), false).ToString();
            DeductCommission = ChallanValues[20][1].ToString();
        ...
        public int InsertChallan()
        {
            ...
            try
            {
                ...
                PM[29] = new SqlParameter("@Id", SqlDbType.Int) { Value = Id };
