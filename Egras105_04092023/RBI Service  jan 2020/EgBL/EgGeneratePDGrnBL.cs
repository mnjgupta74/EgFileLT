...
namespace EgBL
{
    public class EgGeneratePDGrnBL
    {
        ...
        public void CheckOfcTreasDeptMapping()
        {
            ...
            catch (Exception ex)
            {
                EgErrorHandller obj = new EgErrorHandller();
                obj.InsertError(ex.Message);
                throw new Exception("Some Technical Error in Office Treasury Department Mapping !");
            }
        }
        ...
        public void CheckBudgetHeadConditions()
        {
            ...
            objEgCheckBudgetHead.PDAcc = pdaccNo;
            objEgCheckBudgetHead.PayMode = Paymenttype;
            objEgCheckBudgetHead.TreasuryCode = Location;
            ...
            objEgCheckBudgetHead.ChallanType = "PD";
            ...
            catch (Exception ex)
            {
                EgErrorHandller obj = new EgErrorHandller();
                obj.InsertError(ex.Message);
                throw new Exception("Some Technical Error in BudgetHead conditons !");
            }
        }
        ...
        public void GetBudgetHeadDtGeneral()
        {
            createTable();
            int sno = 1;
            double amount = 0;
        ...
        public void SplitToProperties(string PlainText)
        {
            ...
            Profile = "0";
            UserId = "73";
            pdaccNo = objEgDeptIntegrationPropBL.PdAcc(ChallanValues[35][1].ToString().Split(':').GetValue(1).ToString().Trim());
        ...
        public int InsertChallan()
        {
            ...
            try
            {
                ...
                PARM[15] = new SqlParameter("@Id", SqlDbType.BigInt) { Value = Id };
                ...
                PARM[21] = new SqlParameter("@PdAcc", SqlDbType.Int) { Value = pdaccNo };
                ...
                PARM[22] = new SqlParameter("@Filler", SqlDbType.Int) { Value =Convert.ToInt16( Filler) };
                PARM[23] = new SqlParameter("@DivCode", SqlDbType.Int) { Value = DivCode };
                PARM[24] = new SqlParameter("@IpAddress", SqlDbType.NVarChar, 50) { Value = System.Web.HttpContext.Current.Request.ServerVariables[ConfigurationManager.AppSettings["IPAddressHTTP"]].ToString() };
