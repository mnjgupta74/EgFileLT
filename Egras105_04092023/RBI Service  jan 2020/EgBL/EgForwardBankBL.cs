   ...
   public class EgForwardBankBL
    {
       public void ForwardBank(string cipherText, string Merchantcode, string url)
       {
           ...
           string Address = "https://Egras.raj.nic.in/WebPages/BankForward.aspx";  //"http://localhost:52324/sbi/default.aspx"; //"http://localhost:55863/EgrasWebSite/WebPages/BankForward.aspx";  //"http://localhost:52324/sbi/default.aspx"; //"http://localhost:56933/EgrasWebSite/WebPages/BankForward.aspx"; //  //"http://59.163.35.6/corp/BANKAWAY?Action.UBIShoppingMall.Login.GBASE.Init=Y ";  
