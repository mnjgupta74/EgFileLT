...
namespace EgBL
{
    public class EgErrorHandller
    {
        ...
        public string SetError(string error)
        {
            ...
            PM[0] = new SqlParameter("@ErrorName", SqlDbType.NVarChar,-1) { Value = ErrorName };
            ...
            //    (HttpWebRequest)WebRequest.Create("http://smsgw.sms.gov.in/failsafe/HttpLink?username=" + "egras.auth" + "&pin=" + "Jh*$23et" + "&message=" + "Error:" + ErrorName + "&mnumber=" + "919462223691" + "&signature=" + "EGRASJ");
        ...
        public int InsertError(string error)
        {
            ...
            SqlParameter[] PM = new SqlParameter[2];
            PM[0] = new SqlParameter("@ErrorName", SqlDbType.NVarChar, 1000) { Value = error };
            PM[1] = new SqlParameter("@PageName", SqlDbType.VarChar, 100) { Value = "RBI" };
        ...
        public void InsertStampLog(int MerchantCode, string EncData, string AUIN, Int64 GRN, string LogType)
        {
            ...
            PM[5] = new SqlParameter("@IpAddress", SqlDbType.VarChar, 20) { Value = Convert.ToString(System.Web.HttpContext.Current.Request.ServerVariables["REMOTE_ADDR"]) };
