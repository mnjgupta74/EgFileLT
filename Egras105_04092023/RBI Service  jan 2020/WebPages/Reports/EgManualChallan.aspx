<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage5.master" AutoEventWireup="true" CodeFile="EgManualChallan.aspx.cs" Inherits="WebPages_EgManualChallan" Async="true" %>
   ...
   <%-- <link href="CSS/EgEchallan.css" rel="stylesheet" type="text/css" />--%>
    ...
    <table align="center" border="1" cellpadding="1" cellspacing="1" style="width: 520px;" frame="box" height="700px">
        ...
        <tr>
            <td colspan="3">
                <center>
                    <asp:LinkButton ID="lnkExtraDetails" runat="server" Text="View BreakUp Details" Visible="false"
