<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage5.master" AutoEventWireup="true" CodeFile="EgGetSNABankDetailData.aspx.cs" Inherits="WebPages.Reports.WebPages_EgGetSNABankDetailData" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div _ngcontent-c6="" class="tnHead minus2point5per">
        <h2 _ngcontent-c6="" title="Challan Detail" class="pull-left">
            <span _ngcontent-c6="" style="color: #FFF">SNA Bank Data Details </span></h2>
    ...
    <table align="center" style="width: 100%" border="1">
        <tr>
            <td colspan="6" style="text-align: center; height: 35px; padding-left: 250px" valign="top">
                <asp:RadioButtonList runat="server" Style="color: #336699; text-align: center" ID="rbtnList" RepeatDirection="Horizontal">
                    <asp:ListItem Selected="True" style="margin-right: 30px; " Text="Success " Value="0" />
                    <asp:ListItem Text="Pending " Value="1" style="margin-right: 30px;"/>
                    <asp:ListItem Text="Doubted " Value="2"  style="margin-right: 30px;"/>
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
        ...
        <tr runat="server" id="trrpt" visible="false">
            <td colspan="7">
                <center>
                    <rsweb:ReportViewer ID="rptEgGetSNABankDetailDataSSRS" runat="server" Width="100%" SizeToReportContent="true"
