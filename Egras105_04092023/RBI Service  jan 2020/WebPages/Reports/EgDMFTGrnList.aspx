<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage5.master" AutoEventWireup="true" CodeFile="EgDMFTGrnList.aspx.cs" Inherits="WebPages_Reports_EgDMFTGrnList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script src="../../js/Control.js" type="text/javascript"></script>
    <fieldset style="width: 100%" id="FieldTreasury">
        <legend style="color: #336699;">DMFTGrnList List</legend>
        <table width="100%" style="text-align: center" align="center" border="1" cellpadding="0"
            ...
            <tr>
                <td colspan="3" style="text-align: center; height: 35px" valign="top">
                    <asp:Label ID="Labelheader" runat="server" Text="DMFT Grn List Report" Font-Bold="True"
                ...
                <td colspan="3">
                    <table border="0" cellpadding="0" cellspacing="0" style="font-size: 9pt; font-family: Arial; width: 100%">
                        <tr id="trDmft" runat="server" visible="false">
                            <td>
                                <asp:Repeater ID="RptDMFTGrnList" runat="server">
                                    <HeaderTemplate>
                                        <tr style="background-color: #507CD1; color: White; font-weight: bold; text-align: center; height: 20px">
                                            ...
                                            <td style="color: White; text-align: left;">GRN
                                            </td>
                                            <td style="color: White; text-align: left;">Location
                                            </td>
                                            <td style="color: White; text-align: left;">PdAccNo
                                            </td>
                                            <td style="color: White; text-align: left;">BankChallanDate
                                            </td>
                                    ...
                                    <ItemTemplate>
                                        <tr style="background-color: #EFF3FB; height: 20px;">
                                            ...
                                            <td style="font-size: 15; text-align: left;">
                                                <asp:Label ID="Label1" runat="server" Text='<%# Eval("Grn") %>'></asp:Label>
                                            </td>
                                            <td style="font-size: 15; text-align: left;">
                                                <asp:Label ID="lblLocation" runat="server" Text='<%# Eval("Location") %>'></asp:Label>
                                            </td>
                                            <td style="font-size: 15; text-align: left;">
                                                <asp:Label ID="Label2" runat="server" Text='<%# Eval("pdacc") %>'></asp:Label>
                                            </td>
                                            <td style="font-size: 15; text-align: left;">
                                                <asp:Label ID="lblbankchallandate" runat="server" Text='<%# string.Format("{0:dd/MM/yyyy}", Eval("bankchallandate"))%>'></asp:Label>
                                            </td>
                                    ...
                                    <AlternatingItemTemplate>
                                        <tr style="background-color: #ffffff; height: 20px; font-family: Arial">
                                            ...
                                            <td style="font-size: 15; text-align: left;">
                                                <asp:Label ID="Label3" runat="server" Text='<%# Eval("Grn") %>'></asp:Label>
                                            </td>
                                            <td style="font-size: 15; text-align: left;">
                                                <asp:Label ID="lblLocation" runat="server" Text='<%# Eval("Location") %>'></asp:Label>
                                            </td>
                                            <td style="font-size: 15; text-align: left;">
                                                <asp:Label ID="Label4" runat="server" Text='<%# Eval("Pdacc") %>'></asp:Label>
                                            </td>
                                            <td style="font-size: 15; text-align: left;">
                                                <asp:Label ID="lblbankchallandate" runat="server" Text='<%# string.Format("{0:dd/MM/yyyy}", Eval("bankchallandate"))%>'></asp:Label>
                                            </td>
