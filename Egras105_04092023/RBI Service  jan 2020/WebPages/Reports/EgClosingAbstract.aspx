<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage5.master" AutoEventWireup="true"
    CodeFile="EgClosingAbstract.aspx.cs" Inherits="WebPages_EgClosingAbstract" Title="Closing Abstract" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div _ngcontent-c6="" class="tnHead minus2point5per">
        <h2 _ngcontent-c6="" title="Closing Abstract" class="pull-left">
            <span _ngcontent-c6="" style="color: #FFF">Closing Abstract Report</span></h2>
        <img src="../../Image/help1.png" class="pull-right" style="height: 35px; width: 34px;" data-toggle="tooltip" data-placement="right" title="Closing Abstract Report" />
    </div>
    <table width="100%" style="text-align: center" align="center" border="1">
        ...
        <tr>
            <td>
                ...
                <asp:TextBox ID="txtfromdate" CssClass="form-control" Height="100%" Style="display: initial !important" Width="120" runat="server" TabIndex="1"
            ...
            <td>
                ...
                <asp:TextBox ID="txttodate" CssClass="form-control" Height="100%" Style="display: initial !important" runat="server" Width="120" TabIndex="2"
            ...
            <td colspan="2" >
                <div class="row" >
                    <div class="col-md-3"style="margin-left: -130px;">
                        <asp:Button ID="btnSubmit" Height="33" CssClass="btn btn-default pull-right" runat="server" Text="Show" OnClick="btnSubmit_Click"
                            ValidationGroup="a" TabIndex="3" />
                    </div>
                    <div class="col-md-3">
                        <asp:Button ID="btnPrint" Height="33" CssClass="btn btn-default pull-left" runat="server" Text="PDF" ValidationGroup="a" OnClick="btnPrint_Click" />
                    </div>
        ...
        <tr runat="server" id="trrpt" visible="false">
            <td colspan="2">
                <center>
                    <rsweb:ReportViewer ID="rptClosingAbstruct" runat="server" Width="100%" SizeToReportContent="true"
