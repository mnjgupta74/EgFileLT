<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage5.master" AutoEventWireup="true" CodeFile="OfficeActivateDeactivate.aspx.cs" Inherits="WebPages_To_OfficeActivateDeactivate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div _ngcontent-c6="" class="sectiontopheader tnHead minus2point5per">
        <h2 _ngcontent-c6="" title="BudgetHeadDetail">
            <span _ngcontent-c6="" style="color: #FFF">Office Active/Deactive</span></h2>
    </div>
    <table width="100%" style="text-align: center" align="center" border="1">
        <tr>
            <td align="left" width="50%">
                <b><span style="color: #336699">Department Name : </span></b>&nbsp;
                <asp:DropDownList ID="ddldepartment" runat="server" Width="50%" AutoPostBack="true" 
                    class="chzn-select" OnSelectedIndexChanged="ddldepartment_SelectedIndexChanged">
            ...
            <td align="left">
                ...
                <asp:DropDownList ID="ddllocation" runat="server" Width="50%" AutoPostBack="false" class="chzn-select">
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Select Treasury"
                                ControlToValidate="ddllocation" ValidationGroup="de" InitialValue="0" ForeColor="Red"
                                Style="text-align: center">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" width="100px" height="25px">
                                            <asp:LinkButton ID="lnkDetail" runat="server" CommandName="Ac" 
                                                CommandArgument='<%#DataBinder.Eval(Container.DataItem,"officeid") %>'> 
