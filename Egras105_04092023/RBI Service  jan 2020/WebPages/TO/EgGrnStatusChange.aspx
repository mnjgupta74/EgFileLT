...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="sh1" style="margin-top:20px">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <input id="idGRN" type="number" maxlength="12" min="1" onkeypress="Javascript:return isNumberKey(event)" class="form-control" style="width: 50%" />
            </div>
