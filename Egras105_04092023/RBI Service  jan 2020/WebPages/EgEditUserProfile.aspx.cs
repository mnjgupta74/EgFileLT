...
public partial class WebPages_EgEditUserProfile : System.Web.UI.Page
{
    ...
    public bool send(string uid, string password, string message, string no, string SENDERID)
    {
        ...
        HttpWebRequest myReq =
            //(HttpWebRequest)WebRequest.Create("http://smsgw.sms.gov.in/failsafe/HttpLink?username=" + uid + "&pin=" + password + "&message=" + "Egras Password Reset Code:" + message + "&mnumber=" + no + "&signature=" + SENDERID + "&dlt_entity=" + dlt_entity + "&dlt_tempate_id=" + dlt_tempate_id);
