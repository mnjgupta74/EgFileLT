<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage5.master" EnableViewStateMac="true"
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <fieldset id="Fieldset1" runat="server" width="60%">
                ...
                <table id="Table1" border="0" cellpadding="1" cellspacing="1" align="center" style="width: 100%">
                    <tr>
                        <td colspan="2" align="Center">
                            ...
                            <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtgrn"
                                ErrorMessage="Enter GRN" ValidationGroup="a"></asp:RequiredFieldValidator>--%>
                        </td>
                    </tr>
                    </tr><tr>
                        <td colspan="2"></td>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                <asp:Button ID="btnsubmit" Height="30px" CssClass="btn btn-default" runat="server" Text="Submit" TabIndex="2" OnClientClick="show();" OnClick="btnsubmit_Click"
                                    ValidationGroup="a" />
                            </td>
                        </tr>
                                ...
                                <asp:GridView ID="grdprofile" runat="server" AutoGenerateColumns="False" Width="100%"
                                    ...
                                    <Columns>
                                     ...
                                     <%# Eval("Grn") %> </asp:LinkButton>  --%>
                                        ...
                                        <ItemTemplate>
                                            <asp:ImageButton ID="imgPrintbtn" ImageUrl="~/Image/prinetr.png" runat="server" Width="20"
                                                Height="25" OnClick="imgPrintbtn_Click" ToolTip="Print" />
                                        </ItemTemplate>
            ...
            <%--     <asp:Panel ID="pnlVisible" runat="server" Style="position: absolute; top: 10px; left: 10px;
                height: 300px; width: 900px; background-color: Transparent; z-index: 1002" />--%>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
