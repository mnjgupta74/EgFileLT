        ...
        <div class="container" style="text-align: center">
            ...
            <div runat="server" id="tblTestBank" style="margin-top: 10%;">
                <table style="width: 100%; margin-top: 30px">
                    ...
                    <tr>
                        <td style="width: 40%; text-align: right">debitBankCode :
                        </td>
                        <td style="width: 60%; text-align: left">
                            <asp:TextBox ID="txtdebtbankcode" runat="server" Style="color: gray;"></asp:TextBox>
                        </td>

                    </tr>
                     <tr>
                        <td style="width: 40%; text-align: right">BakRefCode :
                        </td>
                        <td style="width: 60%; text-align: left">
                            <asp:TextBox ID="txtBakRefCode" runat="server" Style="color: gray;"></asp:TextBox>
                        </td>

                    </tr>
                    <tr>
                        <td style="width: 40%; text-align: right">Paymode :
                        </td>
                        <td style="width: 60%; text-align: left">
                            <asp:TextBox ID="txtPaymode" runat="server" Style="color: gray;"></asp:TextBox>
                        </td>

                    </tr>
                     <tr>
                        <td style="width: 40%; text-align: right">Reason :
                        </td>
                        <td style="width: 60%; text-align: left">
                            <asp:TextBox ID="txtReason" runat="server" Style="color: gray;"></asp:TextBox>
                        </td>
