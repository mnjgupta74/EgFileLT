...
public class CPINPULLREQService : ICPINPULLREQService
{
    public System.IO.Stream CPINPullRequest(CPINPullRequest CPINString)
    {
        ...
        try
        {
            ...
            obj.InsertError("CPINPullRequest String : - Payload={ cpin=" + CPINString.Payload.CPIN + "}, System=" + CPINString.System + ",ServiceType=" + CPINString.ServiceType + " Signature=" + CPINString.Signature + " , IPAddress =" + IPAddress);
    ...
    public System.IO.Stream CPINNotificationRequest(CPINNotificationRequestr NotifyDetail)
    {
        ...
        {
            EgErrorHandller obj = new EgErrorHandller();
            obj.InsertError("CPINNotificationRequest String : - Payload={ cpin=" + NotifyDetail.Payload.CPIN + ", UTR=" + NotifyDetail.Payload.UTR + ", Total Amount=" + NotifyDetail.Payload.TotalAmt + ",Payment Date=" + NotifyDetail.Payload.PaymentDtTm + ", BankRefrenceNO =" + NotifyDetail.Payload.BankRefNo + "}, System=" + NotifyDetail.System + ",ServiceType=" + NotifyDetail.ServiceType + " Signature=" + NotifyDetail.Signature + " , IPAddress =" + IPAddress);
