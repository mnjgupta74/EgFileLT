...
public class IntegrationClass : IntegrationInterface
{
    ...
    int MerchantCode;   Int16 version = 1;
    ...
    { }
    public IntegrationClass(string EncData, string AUIN, int MerchantCode, string ChallanType , Int16 version)
    {
    ...
    public bool IntegrationInterface()
    {
        try
        {
            ...
            {
                PlainText = objEncryptDecrypt.DecryptSBIWithKey256(EncData, System.Web.Configuration.WebConfigurationManager.AppSettings["Securekey"] + MerchantCode + ".key",null);
                PlainChlnType = ChallanType == "" || ChallanType == null ? "0|0" : objEncryptDecrypt.DecryptSBIWithKey256(ChallanType, System.Web.Configuration.WebConfigurationManager.AppSettings["Securekey"] + MerchantCode + ".key",null);
            }
