...
public abstract class Banks
{
    ...
    public string Version { get; set; } // Add Version Field 18 Jan 2022 For SHA256
    ...
    public virtual Dictionary<string, string> GetBankForwardString()
    {
        ...
        if (Convert.ToInt64(GRN.ToString()) != Convert.ToInt64(HttpContext.Current.Session["GrnNumber"]) )
        {
