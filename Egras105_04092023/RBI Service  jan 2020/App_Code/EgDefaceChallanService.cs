...
public class EgDefaceChallanService : IEgDefaceChallanService
{
    public string DefaceChallan(string Parameter)
    {
        try
        {
            ...
            if (refCheck == 0)
            {
                ...
                {
                    objEgDefaceDetailServiceBL.EncData = Parameter;
                ...
                {
                    objEgDefaceDetailServiceBL.EncData = Parameter + "_Reference Number Mismatch";
            ...
            {
                objEgDefaceDetailServiceBL.EncData = Parameter + "_Invalid IPAddress";
            ...
            else
            {
                ...
                objEgDefaceDetailServiceBL.EncData = Parameter + "_Duplicate Reference Number";
        ...
        {
            EgDefaceDetailServiceBL objEgDefaceDetailServiceBL = new EgDefaceDetailServiceBL();
            objEgDefaceDetailServiceBL.EncData = Parameter + "Error: " + ex.Message;
    ...
    public string VerifyReferenceNo(string Parameter)
    {
        try
        {
            ...
            EgDefaceDetailServiceBL objEgDefaceDetailServiceBL = new EgDefaceDetailServiceBL();
            SbiEncryptionDecryption objDecrypt = new SbiEncryptionDecryption();
            objEgDefaceDetailServiceBL.EncData = "Verify_" + Parameter;
        ...
        {
            EgDefaceDetailServiceBL objEgDefaceDetailServiceBL = new EgDefaceDetailServiceBL();
            objEgDefaceDetailServiceBL.EncData = "Verify_" + Parameter + "Error: " + ex.Message; ;
            objEgDefaceDetailServiceBL.MessageStatus = "Error Accesing Service";
            objEgDefaceDetailServiceBL.DefaceAuditLogs();
