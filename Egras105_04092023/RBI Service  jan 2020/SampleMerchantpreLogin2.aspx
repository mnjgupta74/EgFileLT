<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SampleMerchantpreLogin2.aspx.cs"
    Inherits="SampleMerchantpreLogin2" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="http://164.100.153.105/Egras105/js/jquery-3.6.0.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        function btnGuestClick() {
            ...
            $.ajax({
                type: 'POST',
                url: 'SampleMerchantpreLogin2.aspx/GetBanks',
                data: '{"EncData":"' + $("#hdnEncData").val() + '","AUIN":"' + $("#hdnAUIN").val() + '","Mcode":"' + $("#hdnMCode").val() + '","ChallanType":"' + $("#hdnCType").val() + '","Version":"' + $("#hdnVersion").val() + '" }',
    ...
    <script type="text/javascript">
        function btnPaySubmit() {
            ...
            $.ajax({
                type: 'POST',
                url: 'SampleMerchantpreLogin2.aspx/SubmitChallan',
